...
static void it_can_turn_left_a_small_amount(void) {
  AOC_CU_ASSERT_EQUAL(
      day1Part1("test/data/day1/it_can_turn_left_a_small_amount.txt"), 0L, "%ld");
  AOC_CU_ASSERT_EQUAL(
      day1Part2("test/data/day1/it_can_turn_left_a_small_amount.txt"), 0L, "%ld");
}
...
static void it_can_turn_right_and_pass_zero(void) {
  AOC_CU_ASSERT_EQUAL(
      day1Part1("test/data/day1/it_can_turn_right_and_pass_zero.txt"), 0L, "%ld");
  AOC_CU_ASSERT_EQUAL(
      day1Part2("test/data/day1/it_can_turn_right_and_pass_zero.txt"), 1L, "%ld");
}

static void it_can_turn_left_and_pass_zero(void) {
  AOC_CU_ASSERT_EQUAL(
      day1Part1("test/data/day1/it_can_turn_left_and_pass_zero.txt"), 0L, "%ld");
  AOC_CU_ASSERT_EQUAL(
      day1Part2("test/data/day1/it_can_turn_left_and_pass_zero.txt"), 1L, "%ld");
}
